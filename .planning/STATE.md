...
- Tablas numeradas (2026-08-11): toda tabla de la lección S07 lleva **`Tabla <fase>.<n> — descripción`** en negrita antes de la tabla. Se aplica fase por fase conforme se modifican (Fase 0: 0.1 RSRP, 0.2 SINR, 0.3 servicios, 0.4 R_usuario hora cargada, 0.5 requisitos; Fase 1: 1.1 bandas, 1.2 franjas FR1/FR2, 1.3 numerologías; Fase 2: 2.1 términos DL, 2.2 sigma shadowing, 2.3 margen vs meta, 2.4 repartos R4-UL). El examen referencia tablas por número como pista ("verifica la Tabla 0.2").
