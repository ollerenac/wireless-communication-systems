...
- Registro léxico (2026-08-12b): **"ancla" prohibida** → **"referencia de la industria"**. **"promesa/prometer" prohibidos** → **"oferta (comercial)"/"ofrecer"** (lenguaje real de planificación, no de blog).
