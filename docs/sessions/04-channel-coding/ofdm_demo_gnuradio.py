...
class ofdm_demo_gnuradio(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ofdm_demo_gnuradio")
        ...
        self.tabs.addTab(self.tabs_widget_1, 'Tx Tiempo')
        self.tabs_widget_2 = Qt.QWidget()
        self.tabs_layout_2 = Qt.QBoxLayout(Qt.QBoxLayout.TopToBottom, self.tabs_widget_2)
        self.tabs_grid_layout_2 = Qt.QGridLayout()
        self.tabs_layout_2.addLayout(self.tabs_grid_layout_2)
        self.tabs.addTab(self.tabs_widget_2, 'Rx Tiempo')
        ...
        self.tabs.addTab(self.tabs_widget_3, 'Rx Espectro')
        ...
        self.tabs.addTab(self.tabs_widget_4, 'Rx Const')
        ...
        self.tabs.addTab(self.tabs_widget_5, 'Subportadoras')
        ...
        self.qtgui_vector_sink_f_0.set_y_axis((-60), 60)
        ...
        self.tabs_layout_5.addWidget(self._qtgui_vector_sink_f_0_win)
        self.qtgui_time_sink_x_1 = qtgui.time_sink_c(
            (fft_size+cp_len), #size
            samp_rate, #samp_rate
            "Rx: Senal Recibida", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.tabs_layout_3.addWidget(self._qtgui_freq_sink_x_0_win)
        ...
        self._noise_amp_range = Range(0, 2, 0.01, 0, 200)
        self._noise_amp_win = RangeWidget(self._noise_amp_range, self.set_noise_amp, "Ruido (sigma)", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.digital_chunks_to_symbols_xx_0 = digital.chunks_to_symbols_bc(qpsk_const.points(), 1)
        ...
        self.analog_random_uniform_source_x_0 = analog.random_uniform_source_b(0, 2, 1)
        ...
        self.connect((self.digital_ofdm_cyclic_prefixer_0, 0), (self.qtgui_time_sink_x_0, 0))
...
def main(top_block_cls=ofdm_demo_gnuradio, options=None):
